...
<html>
    ...
    <body>
        <div id="parent-container" class="container bg-success">
                    ...
                    <div class="col-lg-12" style="background-color: white; height: 390px;z-index: 5">
                        ...
                        <div id="link" class="col-lg-12 btn-secondary">
                            ...
                            <div class="btn-group padding-right">
                                <button type="button" style="border-radius: 10px;"  class="btn btn-lg btn-secondary bg-primary hlnk" data-toggle="dropdown"><span>Employee</span> <span class="caret"></span></button>
            ...
            <div id="nav" class="row" style="z-index: -1">
            ...
            <!--<br style="clear: both"/>-->
            <!-----The footer---->
            <div id="footer" class="row modal-footer " style="z-index: 1">
                <div class="col-lg-12">
                </div>
            </div>
        </div>
