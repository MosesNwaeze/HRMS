...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                var vaError = [];
                $("#employeeIDValidate").hide();
                $("#usernameValidate").hide();
                $("#passwordValidate").hide();

                $("#id").blur(function () {
                    if ($("#id").val() === "") {
                        $("#employeeIDValidate").show();
                        vaError.push("ID cannot be empty");
                    }
                });
                $("#username").blur(function () {
                    if ($("#username").val() === "") {
                        $("#usernameValidate").show();
                        vaError.push("Username cannot be empty");
                    }
                });
                $("#password").blur(function () {
                    if ($("#password").val() === "") {
                        $("#passwordValidate").show();
                        vaError.push("Password cannot be empty");
                    }
                });
                    ...
                    if (vaError.length === 0) {
                        $.ajax({
                            ...
                            success: function (data, textStatus, jqXHR) {
                                //$("#message").append(data).css({"color": "green", "font-size": "25px"});
                            },
    ...
    <body>
        <div id="parent-container" class="container bg-success">
            ...
            <div class="row bg-success registrationForm" id="signupFormParentContainer">
                <div class="col-lg-3"></div>
                <div class="col-lg-9">
                    <div id="message">
                        <h3 class="text-success h3">Employee Successfully SignedUp <button type="button" id="toLogin" class="btn btn-success"><i class="glyphicon glyphicon-log-in"></i> Login</button></h3>
                    </div>
                    <fieldset role="form" id="fieldset">
                        <legend style="margin-top: 20px;" class="text-uppercase"><b>Registration form</b></legend>

                        <form name="registrationForm" method="POST" action="signup" id="registrationForm">
                            <div class="form-group col-lg-8">
                                <label class="control-label text-danger" id="employeeIDValidate">
                                    EmployeeID cannot be empty
                                </label><br>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input id="id" type="text" class="form-control" name="id" placeholder="EmployeeID">
                                </div>
                                <br><br>
